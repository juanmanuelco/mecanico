...
var TallerRegistroMecanicoPage = /** @class */ (function () {
    ...
    TallerRegistroMecanicoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-taller-registro-mecanico',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\taller-registro-mecanico\taller-registro-mecanico.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Registrar mecánico</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding class="centrado">\n  <h1>Registro de mecánicos</h1>\n  <ion-item>\n    <ion-label color="primary" floating>Nombre del mecánico</ion-label>\n    <ion-input aria-placeholder="Nombre" type="text" [(ngModel)]="txt_mecanico_nombre"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-label color="primary" floating>Email del mecánico</ion-label>\n    <ion-input aria-placeholder="Email" type="email" [(ngModel)]="txt_mecanico_mail"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-label color="primary" floating>Contraseña</ion-label>\n    <ion-input aria-placeholder="Email" type="password" [(ngModel)]="txt_mecanico_password"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-label color="primary" floating>Repetir contraseña</ion-label>\n    <ion-input aria-placeholder="Email" type="password" [(ngModel)]="txt_mecanico_rpassword"></ion-input>\n  </ion-item>\n  <div class="div_margen_bt">\n    <button ion-button full (click)="Registrar()" [disabled]="!reg_status">Registrar</button>\n  </div>\n  <ion-spinner name="crescent" *ngIf="status"></ion-spinner>\n</ion-content>'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\taller-registro-mecanico\taller-registro-mecanico.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
var TallerModEliMecanicoPage = /** @class */ (function () {
    ...
    TallerModEliMecanicoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-taller-mod-eli-mecanico',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\taller-mod-eli-mecanico\taller-mod-eli-mecanico.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Mecánicos registrados</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-item style="margin-bottom:12px">\n    <ion-input placeholder="Buscar taller" [(ngModel)]="parametro" type="text" (keyup)="buscarMecanico()"></ion-input>\n    <ion-label color="primary">Buscar</ion-label>\n  </ion-item>\n\n  <ion-grid>\n    <ion-row class="centrado">\n      <ion-col col-4> <b>Email</b> </ion-col>\n      <ion-col col-3><b>Nombre</b></ion-col>\n      <ion-col col-5><b>Acciones</b></ion-col>\n    </ion-row>\n    <ion-row *ngFor="let mecanico of mecanicos" class="mecan-reg" style="border-bottom: 1px dashed rgb(100, 95, 95); padding: 4px;">\n        <ion-col col-4><i class="mec-nom">{{mecanico.username}}</i></ion-col>\n        <ion-col col-3><i class="mec-nom">{{mecanico.nombre}}</i></ion-col>\n        <ion-col col-5>\n            <ion-buttons end>\n                <button ion-button icon-only>\n                  <ion-icon ios="ios-create" md="md-create" name="create"></ion-icon>\n                </button>\n                <button ion-button icon-only color="danger" (click)="eliminarMecanico(mecanico.identidad)">\n                  <ion-icon name="trash" ios="ios-trash" md="md-trash"></ion-icon>\n                </button>\n              </ion-buttons>\n        </ion-col>\n    </ion-row> \n  </ion-grid>\n</ion-content>'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\taller-mod-eli-mecanico\taller-mod-eli-mecanico.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_validaciones_validaciones__["a" /* ValidacionesProvider */],
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\app\app.html"*/
        }),
...
var PrincipalAdminPage = /** @class */ (function () {
    ...
    PrincipalAdminPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-principal-admin',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-admin\principal-admin.html"*/'<ion-header>\n  <ion-toolbar>\n    <ion-title>Panel de control Administrador</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only color="royal" (click)="menu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <h1 class="centrado">Incidencias pertenece al modulo 4</h1>\n</ion-content>\n\n\n\n\n\n<ion-header>\n  <ion-toolbar>\n    <ion-title>Panel de control Administrador</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only color="royal" (click)="menu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <h1 class="centrado">Incidencias pertenece al modulo 4</h1>\n</ion-content>\n\n\n\n\n\n'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-admin\principal-admin.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
var PrincipalMecanicoPage = /** @class */ (function () {
    ...
    PrincipalMecanicoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-principal-mecanico',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-mecanico\principal-mecanico.html"*/'<!--\n  Generated template for the PrincipalMecanicoPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-toolbar>\n      <ion-title>Panel de control Mecanico</ion-title>\n      <ion-buttons end>\n        <button ion-button icon-only color="royal" (click)="menu()">\n          <ion-icon name="menu"></ion-icon>\n        </button>\n      </ion-buttons>\n    </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-mecanico\principal-mecanico.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */]])
...
var PrincipalTallerPage = /** @class */ (function () {
    ...
    PrincipalTallerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-principal-taller',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-taller\principal-taller.html"*/'\n<ion-header>\n\n  <ion-toolbar>\n    <ion-title>Panel de control Taller</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only color="royal" (click)="menu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <h1 class="centrado">Incidencias pertenece al módulo 4</h1>\n</ion-content>\n'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-taller\principal-taller.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */]])
...
var PrincipalUsuarioPage = /** @class */ (function () {
    ...
    PrincipalUsuarioPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["m" /* Component */])({
            selector: 'page-principal-usuario',template:/*ion-inline-start:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-usuario\principal-usuario.html"*/'<ion-header>\n  <ion-toolbar>\n    <ion-title>Principal usuario</ion-title>\n    <ion-buttons end>\n      \n      <button ion-button icon-only color="royal" (click)="logout()">\n        <ion-icon name="exit"></ion-icon>\n      </button>\n      <button ion-button icon-only color="royal" (click)="abrir_cambio()">\n          <ion-icon ios="ios-construct"  md="md-construct"></ion-icon>\n        </button>\n\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content></ion-content>\n\n<ion-footer>\n\n</ion-footer>'/*ion-inline-end:"D:\proyectos\mecanico\mecanico_app_v7\mecanico\src\pages\principal-usuario\principal-usuario.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavParams */],
